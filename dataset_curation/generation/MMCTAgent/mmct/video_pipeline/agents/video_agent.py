...
class VideoAgent:
    ...
    async def __call__(self) -> VideoAgentResponse:
        ...
        try:
            ...
            # since _generate_final_answer converts video_qna_response to string, we temporatrily remove history from it and then add it back
            history_logs = video_qna_response.pop("history")
            ...
            # adding history back and appending this to our final response too.
            video_qna_response["history"] = history_logs
            formatted_response["video_agent_response_history"] = video_qna_response
