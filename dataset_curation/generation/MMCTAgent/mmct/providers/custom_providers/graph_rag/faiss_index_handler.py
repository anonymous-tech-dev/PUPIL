...
if __name__=='__main__':
    ...
    index_manager = FaissIndexManager(dim=3072, index_path="faiss_index.index", mapping_path="id_mapping.json")
    ...
    embeddings = np.random.rand(100, 3072).astype(np.float32)
