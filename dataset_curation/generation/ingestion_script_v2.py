...
TRANSCRIPT_DIR = "/home/Pupil/dataset_curation/dataset/transcripts_db/edubench_train_db"
...
async def process_video(video_path, current_idx):
    ...
    try:
        ...
        print(f"🎉 Completed {base_name} in {duration/60:.2f} minutes.")
        return "SUCCESS", None
        ...
        duration = time.time() - start_time
        print(f"⏳ Failed after {duration/60:.2f} minutes: {base_name}")
