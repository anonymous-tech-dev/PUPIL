...
VIDEO_NAME = "engg_drawing_mod05lec27"
SOURCE_OF_FACT: Literal['audio', 'visual'] = 'visual'
TARGET_QUESTION_COUNT = 5

TRANSCRIPT_DIR = Path("/home/Pupil/dataset/transcripts_db")
OUTPUT_DIR = Path("/home/Pupil/dataset/queries_db/exp_v3/sof_vid/")
...
async def generate_curated_dataset():
    ...
    Focus strictly on {source_type} details and questions being related to the education domain of the video.
