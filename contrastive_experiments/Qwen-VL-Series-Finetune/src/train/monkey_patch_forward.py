...
def qwen3_vl_moe_mixed_modality_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    if (input_ids is None) ^ (inputs_embeds is not None):
        # TRL's DPOTrainer may pass BOTH input_ids and inputs_embeds (it
        # pre-embeds for the concatenated forward but keeps input_ids around
        # for image/video placeholder masks). Tolerate that case.
